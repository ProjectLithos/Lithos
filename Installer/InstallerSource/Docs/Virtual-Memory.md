...
OESDK 0.17.22 provides an explicit x86-64 page-table manager over the active CR3 address space. It deliberately retains the bootstrap identity map. A higher-half kernel relocation is deferred until mapping, translation, invalidation and allocation are dependable.
