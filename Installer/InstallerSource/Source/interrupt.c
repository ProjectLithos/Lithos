...
_Static_assert(offsetof(OesdkInterruptFrame, Vector) == 120U, "interrupt frame register layout changed");
_Static_assert(offsetof(OesdkInterruptFrame, Rip) == 136U, "interrupt frame CPU layout changed");
