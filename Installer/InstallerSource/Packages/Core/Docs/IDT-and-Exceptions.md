...
OESDK 0.17.13 provides a kernel-owned x86-64 IDT with all 256 entries and architectural exception stubs for vectors 0 through 31.
...
See [Page-Fault Decoding](Page-Fault-Decoding.md) for the complete CR2 and error-code contract.
