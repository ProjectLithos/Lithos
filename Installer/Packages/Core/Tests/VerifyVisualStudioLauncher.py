...
for rel in ['Tools/VisualStudio-Launch.ps1','Packages/x86_64/Tools/VisualStudio-Launch.ps1','InstallerSource/Packages/x86_64/Tools/VisualStudio-Launch.ps1']:
    ...
    assert 'public static class NativeDebuggerProbe' in text, rel
    assert 'public static extern bool IsDebuggerPresent();' in text, rel
    assert 'internal static class NativeDebuggerProbe' not in text, rel
